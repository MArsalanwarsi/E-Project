            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    <a href="javascript:;" class="has-arrow">
                        ...
                        <div class="menu-title">Merchendise</div>
                    </a>
                    <ul>
                        <li> <a href="All_Products.php"><i class="bx bx-right-arrow-alt"></i>Products</a>
                        </li>
                ...
                <li>
                    ...
                    <ul>
                        <li> <a href="All_Categories.php"><i class="bx bx-right-arrow-alt"></i>All Categories</a>
                        </li>
                        <li> <a href="add_new_category.php"><i class="bx bx-right-arrow-alt"></i>Add New Caterories</a>
                        </li>
                    </ul>
                </li>
                ...
                <nav class="navbar navbar-expand">
                    ...
                    <div class="user-box dropdown ">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" href="../logout.php?redirect=admin"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
                            </li>
                        </ul>
                    </div>
                </nav>
